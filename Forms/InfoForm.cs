...
namespace RFAB_builder.Forms
{
    public partial class InfoForm : Form
    {
        ...
        private void InfoForm_Load(object sender, EventArgs e)
        {
            ...
            InfoLabel.Text =  $@"RFABulder программа для легкого и удобного создания{Environment.NewLine}своих билдов в Requiem For A Balance.{Environment.NewLine}Автор: EBCEY.{Environment.NewLine}О возникших ошибках и пожеланиях можно написать мне в дискорд.{Environment.NewLine}При ошибках отправляйте логи{Environment.NewLine}{Logger.Path}";
        }
